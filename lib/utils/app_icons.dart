class AppIcons{
  ...
  static String massegeIcon ="$path/message.svg";
  static String profileIconBottombar ="$path/profile_icon.svg";
  ...
  static String bookingRequest ="$path/user_help_offer.svg";
