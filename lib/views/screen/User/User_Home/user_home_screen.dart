            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: (){
                      Get.toNamed(AppRoutes.allNearbayScreen,  parameters: {"screenType" : AppString.nearbyHelps});
                    },
                    child: CustomText(
                        text: AppString.seeAll,
                        fontsize: Dimensions.fontSizeDefault.h,
              ...
              Container(
                ...
                child: ListView.builder(
                  scrollDirection: Axis.horizontal,
                  itemCount: _homeCtrl.popularHelpModel.value.length,
                  itemBuilder: (context, index) {
                    var nearbyInfo=_homeCtrl.popularHelpModel.value[index];
                    return Padding(
                      padding: EdgeInsets.only(left: index == 0 ? 0 : 18.w),
                      child:  ServiceCard(
                        onTap: (){
